...
\caption{Compression sweep (synthetic): triangulation RMS as a percentage of mean depth versus codec quality. The ray-based backend remains stable across codec settings on this benchmark, while pinhole-based pipelines are sensitive to lossy compression.}
