...
ray-field requires additional constraints (e.g., multiple board poses and/or multiple planes), and naturally connects to
general imaging models and ray-based calibration formulations~\cite{miraldo2011pointbased}.
...
\begin{itemize}
  ...
  \item Extension from plane-only non-parametric warps to a full 3D per-pixel ray-field (and stereo triangulation) using multiple
        target poses and/or multiple calibration planes, following ray-based general imaging model parameterizations~\cite{miraldo2011pointbased}.
