...
This page explains the two inverse problems, documents the evidence
(synthetic benchmarks and real CMO hardware — see Notebook 09), and
provides practical guidance on when to use each strategy.
...
Experiments at different levels of completeness — including a real
CMO microscope (Pycaso, Notebook 09) — support the architectural argument:
