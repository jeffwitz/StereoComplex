...
This page is the practical entry point for the experimental non-central
...
The non-central Zernike origin-field backend is experimental. It is already
useful for controlled benchmarks and for testing systems where the central-camera
assumption is visibly biased, but it should not yet be treated as a turnkey
